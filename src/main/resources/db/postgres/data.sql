...
INSERT INTO specialties (name) SELECT 'Mathematics' WHERE NOT EXISTS (SELECT * FROM specialties WHERE name='Mathematics');
INSERT INTO specialties (name) SELECT 'Physics' WHERE NOT EXISTS (SELECT * FROM specialties WHERE name='Physics');
INSERT INTO specialties (name) SELECT 'Chemistry' WHERE NOT EXISTS (SELECT * FROM specialties WHERE name='Chemistry');
